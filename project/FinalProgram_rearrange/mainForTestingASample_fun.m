function [ output_args ] = mainForTestingASample_fun ( videoPath, signName )
...
PreCalculateFolder = '/eecf/cbcsl/data100/Qianli2/AASLIE/AASLIE/FinalProgram/PreCalculateData3/';
...
videoPath = [folderpath,'/',name,'/',version,'/','Qianli_newframe3__M_S_05_imitation.avi'];
...
% coefficients. 
t = cputime;
[ TestIDCTcells,TestDCT,TestFeatureResult,DissmilarityVect,data_cell ] = TestFromVideo2DCT_ver2( videoPath,InputType,CameraAlign,ProcusModel,show);
