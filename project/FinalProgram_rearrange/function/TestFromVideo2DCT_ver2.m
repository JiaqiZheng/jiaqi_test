function [ IDCTcell,DCTMatrix,VideoSiftResultNoFace,dissimilarity,data_cell ] = TestFromVideo2DCT_ver2( video_color, video_gray,inputType,CameraAlign,ProcusModel,show)
...
tic
VideoSiftResult = FromVideo2SIFTStruct(video_color,video_gray,inputType,show);
...
%%
function VideoSiftResult = FromVideo2SIFTStruct(video_color,video_gray,InputType,show)
